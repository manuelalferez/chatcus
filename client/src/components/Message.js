...
const Message = ({ message: { user, text }, name }) => {
  ...
  return isSentByCurrentUser ? (
    ...
    <div className="flex mx-auto px-3 py-1 rounded-2xl bg-blue-100 w-max shadow-sm my-2 overflow-hidden">
      <div>
    ...
    <div className="flex flex-col items-start p-2 rounded-t-xl rounded-r-xl w-max max-w-xs bg-green-500 shadow-md text-white m-2 overflow-hidden lg:max-w-lg">
      <p className="pl-2 text-green-100 text-sm font-semibold">{user}</p>
      <div>
